...
public class Multiset<E> {
     ...
     * @return true if this multiset is empty
     */
    public Multiset<E> intersection(Multiset<E> multiset) {
    	Multiset<E> intersectionMultiset = new Multiset();
    	E object;
    	
    	//Iterate through the multiset values
    	for (int i = 0; i < multiset.getValues().size(); i++) {
    		object = multiset.getValues().get(i);
    		
    		//If set contains the object
            if(contains(object)) {
            	//add the object and the minimum  count in the intersection multiset
            	intersectionMultiset.add(object, Math.min(count(object), multiset.count(object)));
            }
        }
    	
    	//Return the intersection of the multisets
...
//        multiset.addAll(Arrays.asList("USA", "China", "Japan"));
// 
//        System.out.println(multiset);
//        
//        multiset2.add("USA", 3);
////        multiset2.add("Japan", 4);
//        multiset2.add("India", 2);
//        multiset2.add("China", 1);
//        
//        System.out.println(multiset2);
//        
//        System.out.println(multiset.intersection(multiset2));
//        
//        System.out.println(multiset.elementSet());
//        System.out.println(multiset2.elementSet());
//        
//        for (String temp : multiset.elementSet()) {
//            System.out.println(temp);
//         }
//        
////        multiset2.forEach((n) -> System.out.println(n));
//        
// 
